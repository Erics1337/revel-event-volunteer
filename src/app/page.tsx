      ...
      <main className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-text mb-8">
            May 4–8, 2026 · Community-built, community-owned, community-first
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-6 rounded-lg border border-gray-border">
            ...
            <h3 className="text-lg font-semibold text-charcoal mb-2">200+ Events</h3>
            <p className="text-gray-text">
              Workshops, panels, keynotes, and networking events across Boulder.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-border">
            ...
            <h3 className="text-lg font-semibold text-charcoal mb-2">4,000+ Attendees</h3>
            <p className="text-gray-text">
              Connect with founders, developers, designers, and community members.
            </p>
          </div>
        ...
        <div className="bg-white p-8 rounded-lg border border-gray-border text-center">
          <h2 className="text-2xl font-bold text-charcoal mb-4">
            Ready to join Boulder Startup Week 2026?
          </h2>
          <p className="text-gray-text mb-6">
            Create your account, browse events, and build your personal schedule.
          </p>
          <Link
            href="/auth/login"
            className="bg-teal-500 text-white px-8 py-3 rounded-md font-medium hover:bg-teal-600 transition-colors"
